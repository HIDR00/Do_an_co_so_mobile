          ...
          body: Container(
            ...
            child: Padding(
              padding: const EdgeInsets.only(
                  left: Dimens.d20, right: Dimens.d20, top: Dimens.d45, bottom: Dimens.d45),
              child: Container(
                height: double.infinity,
                width: double.infinity,
                decoration: const BoxDecoration(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: AppTextStyles.s20w700Title2()
                            .copyWith(color: AppColors.current.baseColors3),
                      ),
                      Padding(
  ...
  Widget _renderButton(GuestOrderState state) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(
            child:
                Text('Done', style: AppTextStyles.s20w700Title2().copyWith(color: Colors.white))),
      ),
    );
  }
}
